---
title: Description of a Pot Stillssss
categories:
- General
excerpt: |
...
A pot still is a type of still used in distilling spirits such as whisky or brandyasdasdasdasd.
 Heat is applied directly to the pot containing the wash (for whisky) or wine (for brandy). This is called a batch distillation (as opposed to a continuous distillation).
